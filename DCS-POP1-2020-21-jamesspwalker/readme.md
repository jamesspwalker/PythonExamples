...
![Visualisation Example](visualisation.PNG)
...
To submit your solution, simply push all the files, that are necessary for your program to run, to the assigned GitHub repo by the corresponding deadline.
...
Notes:
 ...
 - Tests are essential and you must aim to provide at least 5 tests for each testable required function.  Quality of the test matters more than quantity. Try to make your tests maximally diverse so that they catch problems with various inputs.
